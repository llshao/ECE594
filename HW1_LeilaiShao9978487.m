...
for r=[3]
    ...
    for dim=[500]
        ...
        Tensor_R1=TensorGenerator(dimension,lambda_generator1,r);
        Tensor_R2=TensorGenerator(dimension,lambda_generator2,r);
        %% Peform the CP Decomposition
        [lambda1,A_all1,CP_error1,CP_errorall1,ite_final1]=CpALS_v1(Tensor_R1,r);
        [lambda2,A_all2,CP_error2,CP_errorall2,ite_final2]=CpALS_v1(Tensor_R2,r);
        figure()
        plot(CP_errorall1);
        figure()
        plot(CP_errorall2);
